  ...
  return (
    <>
      <header className="flex items-center justify-between py-8 px-8 bg-[#FAFAFA] border-b">
        <div>
          <p className="text-2xl lg:block hidden">پنل مدیریت فروشگاه</p>
        </div>
        <div className="flex md:flex-row flex-col-reverse items-center justify-between gap-x-10 gap-y-2">
          <div>
            <AdminTabs />
          </div>
          <div className="flex gap-5 items-center">
            <Link href="/" className="flex gap-2 items-center">
              ...
              <p className="lg:block hidden">بازگشت به سایت</p>
            </Link>
            ...
            <Link href="/" className="flex items-center gap-2">
              ...
              <p className="lg:block hidden">خروج از حساب کاربری مدیریت</p>
            </Link>
          </div>
        </div>
      </header>
